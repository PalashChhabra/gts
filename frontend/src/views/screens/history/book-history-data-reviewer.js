...
const BookHistoryDataRW = (props) => {
  ...
  if (booksData.length > 0) {
    translationArray = booksData[0].translationHistory;
    reviewArray = booksData[1].reviewHistory;
  }
...
export default BookHistoryDataRW;
